...
@media (min-width: 768px) {
  ...
  .score-panel__elo { font-size: 28px; }
...
.ui-button__icon { width: 22px; height: 22px; flex-shrink: 0; filter: drop-shadow(0 2px 6px rgba(0,0,0,1)) drop-shadow(0 4px 16px rgba(0,0,0,1)) drop-shadow(0 0 20px rgba(0,0,0,0.9)); }
.ui-button__label { text-shadow: 0 2px 6px rgba(0,0,0,1), 0 4px 16px rgba(0,0,0,1), 0 0 20px rgba(0,0,0,0.9); }
.ui-button__label { font-size: 10px; letter-spacing: 1.5px; text-transform: uppercase; color: #f0e8d0; }
...
function MenuOverlay({ isOpen, isVisible, onResume, onNewGame, onOnlineMatch }: {
  isOpen: boolean
  isVisible: boolean
  onResume: () => void
  onNewGame: () => void
