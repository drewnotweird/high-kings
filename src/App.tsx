...
.ui-button__icon { width: 22px; height: 22px; flex-shrink: 0; filter: drop-shadow(0 0 20px rgba(0,0,0,1)) drop-shadow(0 0 12px rgba(0,0,0,1)) drop-shadow(0 0 4px rgba(0,0,0,1)); }
